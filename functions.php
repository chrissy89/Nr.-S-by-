...
wp_enqueue_style( 'wpb-google-fonts', 'https://fonts.googleapis.com/css?family=Baloo+2|Roboto&display=swap', false ); 
}
...
function include_script(){
	...
	wp_enqueue_script('script', get_template_directory_uri() . '/js/script.js', '', 1, true);
